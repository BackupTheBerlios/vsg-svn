...
static TestData _test_data[] = {
  {{0x132, 0x0, 10}, {0x132, 0x0, 10}, 0, {0x132, 0x0, 10}, 0, 0},
  {{0x132, 0x0, 10}, {0x133, 0x0, 10}, 1, {0x99, 0x0, 9}, 0, 1},
  {{0x132, 0x0, 10}, {0x72, 0x0, 10}, 9, {0x0, 0x0, 1}, 1, 0},
  {{0x72, 0x0, 10}, {0x132, 0x0, 10}, 9, {0x0, 0x0, 1}, 0, 1},
  {{0x0, 0x132, 10}, {0x0, 0x132, 10}, 0, {0x0, 0x132, 10}, 0, 0},
  {{0x0, 0x132, 10}, {0x0, 0x72, 10}, 9, {0x0, 0x0, 1}, 2, 0},
  {{0x0aab5, 0x1579b, 17}, {0x555aa, 0xabcde, 20},  3, {0xaab5, 0x1579b, 17}, 0, 3},

  {{0x0, 0x0, 2}, {0x1, 0x2, 2},  2, {0x0, 0x0, 0}, 0, 3},
  {{0x0, 0x0, 2}, {0x1, 0x0, 2},  1, {0x0, 0x0, 1}, 0, 1},

  {{0xff, 0xef, 8}, {0x70, 0xef, 8},  8, {0x0, 0x0, 0}, 1, 0},
  {{0xffaa, 0xefaa, 16}, {0x70aa, 0xefaa, 16},  16, {0x0, 0x0, 0}, 1, 0},

  {{0x1, 0x0, 1}, {0x2, 0x0, 2},  0, {0x2, 0x0, 2}, 0, 0},
  {{0x0, 0x1, 1}, {0x0, 0x2, 2},  0, {0x0, 0x2, 2}, 0, 0},
  {{0x1, 0x0, 1}, {0x4, 0x0, 3},  0, {0x4, 0x0, 3}, 0, 0},
  {{0x0, 0x1, 1}, {0x0, 0x4, 3},  0, {0x0, 0x4, 3}, 0, 0},

  {{0x2, 0x0, 2}, {0x1, 0x0, 1},  0, {0x2, 0x0, 2}, 0, 0},
  {{0x0, 0x2, 2}, {0x0, 0x1, 1},  0, {0x0, 0x2, 2}, 0, 0},
  {{0x4, 0x0, 3}, {0x1, 0x0, 1},  0, {0x4, 0x0, 3}, 0, 0},
  {{0x0, 0x4, 3}, {0x0, 0x1, 1},  0, {0x0, 0x4, 3}, 0, 0},
  //{{0x, 0x, }, {0x, 0x, },  , {0x, 0x, }, , },
